...
for rep in NEW_REPS:
    ...
    if os.environ.get("SA5_STAGE20_SEGMENTED_TIMING", "") == "1":
        print("stage20_segmented_timing_boundary=PASS", flush=True)
        print(f"completed_timing_replication={rep}", flush=True)
        print("stage20_precision_analysis_performed=false", flush=True)
        print("stage20_precision_start_marker_created=false", flush=True)
        print(
