\section{Exemple FoodMart HF/North reformulé dans le contrat actuel}
\label{app:foodmart-post-a8}

Cette annexe conserve l'exemple FoodMart historique comme illustration formelle, mais le reformule avec le graphe objectif--évidence, le CQP et l'évidence acquise du modèle actuel. Elle ne réinterprète aucune campagne expérimentale historique comme preuve confirmatoire de \texttt{SAFE\_PRUNING}.
