...
\[
P_{q_1}=\operatorname{CQP}(q_1)
=(\textit{Sales},\textit{Month},\{\mathrm{Margin\%}\},\mathrm{avg},\%,S_{\mathrm{HF,North}},w_{1998},\Gamma_{q_1},\eta_{q_1}).
\]
...
Le présent exemple démontre la cohérence du raisonnement sur une spécification contrôlée. Il n'établit ni la construction automatique correcte de $G_O$, ni la validité métier indépendante des supports choisis, ni un résultat de performance XMLA/eMondrian. Les campagnes historiques FoodMart restent des preuves de fonctionnement du prototype; la réplication confirmatoire R3-E demeure distincte et pendante.
