# MCAD Decision Detail — S_0001 / step 2
...
- Ceval(QP,O) contient 1 contrainte(s) calculable(s) : aw_real_c2_total_product_cost.
...
```json
{
  ...
  "probe": {
    ...
    "raw_probe_summary": {
      ...
      "elapsed_ms": 36,
      "response_bytes": 1839,
      "response_digest": "16cf8b4a1bc5cbff",
      "result_digest": "16cf8b4a1bc5cbff"
    }
  },
  "empty_reason": null,
...
```json
{
  ...
  "axes": [
    {
      "axis": "COLUMNS",
      "expression": "{[Measures].[TotalProductCost]}"
    },
    {
      "axis": "ROWS",
...
```json
{
  ...
  "direct_bi_execution_count": 2,
  "digest_count": 2,
  "execution_paths": {
    "sqlserver_direct": 2
  },
  "adapters": {
    "adventureworks_direct": 2
  }
}
```
